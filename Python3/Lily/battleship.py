...
BLUE = (0, 120, 215)        # Background water
YELLOW = (255, 255, 0)      # Hit ship part
GRAY = (128, 128, 128)      # Missed shot
RED = (255, 0, 0)           # Ship completely sunk
WHITE = (255, 255, 255)     # Grid lines & text
...
def place_ships_randomly(grid, num_ships=3, hide_ships=True):
  ...
  while ships_placed < num_ships:
    ...
    if can_place_ship(grid, row, col, direction, length):
      ship_coords = place_ship(grid, row, col, direction, length, ships_placed, hide_ships)
